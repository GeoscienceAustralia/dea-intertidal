...
def test_dem_accuracy(
    ...
    mdFile.new_paragraph(
        "> [!NOTE]")
    mdFile.new_line("> *This readme is automatically generated by the ``test_intertidal.py`` script; edits should be made to the ``test_dem_accuracy`` function [located here](../tests/test_intertidal.py).*"
    )
